...
exports.SelectSeatsPage = class SelectYourOwnSeatPage {
  constructor(page) {
    ...
    this.performanceDetailsTitle = this.base.locator('h2[class*="syos-performance-details__title"]');
    ...
    this.allNotAvailableSectorTypes = this.priceTypesEl.locator('[class*="item not-available"][tabindex]');
    this.allAvailableSectorTypes = this.priceTypesEl
      .locator('.syos-level-selector-price-types__item:not(.not-available):not(.bestavailable-order)');
